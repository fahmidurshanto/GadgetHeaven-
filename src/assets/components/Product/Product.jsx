...
const Product = ({product}) => {
    ...
    return (
        <div className="p-4 shadow-md rounded-2xl">
            ...
            <Link to="/details"><button className="text-violet-500 py-3 px-8 border-2 border-violet-500 rounded-full cursor-pointer hover:bg-gray-300">View Details</button></Link>
        </div>
    );
};
